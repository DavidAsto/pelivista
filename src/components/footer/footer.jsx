...
const Footer = () => {
    return(
        <>
        <footer className="main-footer w-full pt-2 pb-8 flex flex-wrap justify-around items-center bg-blue-700">
            <div className="p-4">
            ...
            <div className="flex gap-12 flex-wrap justify-center px-6 pt-8">
                <div className="flex flex-col">
                    <h3 className="mb-1">Informacion</h3>
                    <a href="#">nosotros</a>
                    <a href="#">contacto</a>
                    <a href="#">atencion</a>
                </div>
